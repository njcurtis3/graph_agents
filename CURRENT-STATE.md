...
| Portfolio index | live, **8 nodes** — 3 products, 1 site, 3 tools, 1 vendor drop — ids and `kind` verified 2026-08-28. `roamex` (product) added 2026-08-28 | `graph_agents/portfolio/registry.json` (183 ln), **untracked on purpose** — see below |
